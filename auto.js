// Function to handle form submission and provide feedback
document.getElementById("autoForm").addEventListener("submit", function(event) {
    ...
    if (name && email && route && date) {
        ...
        document.getElementById("formFeedback").textContent = `Thank you, ${name}! You've successfully joined the auto pool for the route: ${route} on ${date}.`;
        document.getElementById("autoForm").reset(); // Reset the form after submission
    } else {
